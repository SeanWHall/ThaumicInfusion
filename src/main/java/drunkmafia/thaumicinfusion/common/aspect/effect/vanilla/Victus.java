...
public class Victus extends AspectEffect {
    ...
    public void updateTick(World world, int x, int y, int z, Random random) {
        ...
        if (System.currentTimeMillis() > this.cooldown + Victus.maxCooldown && rand.nextInt(1000) == 1 && this.drainAspects(world, Aspect.LIFE)) {
            Entity entity = EntityList.createEntityByID(Victus.mobs[rand.nextInt(Victus.mobs.length)], world);
