...
public class ThaumcraftIntergration {
    ...
    public static void init() {
        ...
        InfusionRecipe infusionRecipe = ThaumcraftApi.addInfusionCraftingRecipe("FOCUSINFUSION", new ItemStack(TIItems.focusInfusing), 4, new AspectList().add(Aspect.EARTH, 25).add(Aspect.ORDER, 25).add(Aspect.MIND, 10), new ItemStack(ItemsTC.focusPrimal), new ItemStack[]{new ItemStack(ItemsTC.crystalEssence, 3), new ItemStack(ItemsTC.crystalEssence, 3), new ItemStack(Items.quartz), new ItemStack(ItemsTC.shard, 3), new ItemStack(ItemsTC.crystalEssence, 3), new ItemStack(ItemsTC.shard, 3), new ItemStack(Items.quartz), new ItemStack(ItemsTC.shard, 3)});
